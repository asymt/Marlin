...
#define STRING_CONFIG_H_AUTHOR "asymt" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_LSP_ESP32
#endif
...
#define CUSTOM_MACHINE_NAME "Asymt's Kossel"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 52.6
  #define DEFAULT_bedKi 7.93
  #define DEFAULT_bedKd 232.9
...
#define DELTA
  ...
  #define DELTA_HEIGHT 293.50             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 123              // (mm) Get this value from G33 auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 424.63 }  // default steps per unit for Kossel (GT2, 20 tooth)
